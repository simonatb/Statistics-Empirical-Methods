...
```
### binom - "Хвърляме зар ... пъти"
```
dbinom(k,n,p) - вероятността Х да е = К успеха (да имаме точно K на брой успеха, всеки с вероятност да се случи P като сме хвърлили N пъти)
rbinom(k,n,p) - вероятността Х да е <= К успеха (да имаме точно или по-малко отK на брой успеха, всеки с вероятност да се случи P като сме хвърлили N пъти)
pbinom(N,n,p) - връща вектор с N на брой елемента
```
### geom - "Хвърляме зар докато се падне ..."
```
X ~ Geom(p) ,p {0,1} X = брой неуспехи преди първия успех
001 # x = 2

dgeom(k,p) - докато не се паднат к на брой успеха
rgeom(k,p) - докато не се паднат к на брой или по-малко успеха
pgeom(N,k,p) - вектор
```
### negative binomial - "Хвърляме зар докато се паднат ... . Каква е вероятността да хвърляме не повече от ... пъти?
```
dnbinom(k,r,p) - P е вероятността за успех, = K - броят на неуспехите, R - броят успехи
rnbinom(k,r,p) - P е вероятността за успех, <= K - броят на неуспехите, R - броят успехи
pnbinom(k,r,p) - вектор
```
